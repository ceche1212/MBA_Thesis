...
data<-read.csv("https://www.eia.gov/totalenergy/data/browser/csv.php?tbl=T05.02")

# Filter data for only total of active rotary rigs

data1<-subset(data,data$Description=="Crude Oil, Natural Gas, and Dry Wells Drilled, Total")
rm(data)
...
colnames(data1)<-c("Date","Month","Year","drilled_wells","Units")
