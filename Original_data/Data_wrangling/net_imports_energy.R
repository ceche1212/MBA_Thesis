...
data1<-subset(data,data$Description=="Primary Energy Net Imports")
rm(data)
...
colnames(data1)<-c("Date","Month","Year","net_imports_energy","Units")

net_imports_energy<-data1

save(net_imports_energy,file = "net_imports_energy.RData")